...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public StyleNano(IResourceCache resCache) : base(resCache)
        {
            ...
            var crtMonoBoldStack = new[]
            {
                "/Fonts/Cozette/CozetteVectorBold.ttf",
            ...
            var crtMono13 = resCache.GetFont
            (
                crtMonoStack,
                size: 13
            );
            var crtMono14 = resCache.GetFont
            (
                crtMonoStack,
                size: 14
            );
            var crtMonoBold14 = resCache.GetFont
            (
                crtMonoBoldStack,
                size: 14
            );
            var crtMonoBold16 = resCache.GetFont
            (
                crtMonoBoldStack,
                size: 16
            );
            var crtMonoBold18 = resCache.GetFont
            (
                crtMonoBoldStack,
                size: 18
            );
            ...
            var crtTextFont = useCrtUi ? crtMonoBold14 : notoSans12;
            var crtDimFont = useCrtUi ? crtMono13 : notoSans10;
            var crtHeadingFont = useCrtUi ? crtMonoBold16 : notoSansBold12;
            var crtHeadingBigFont = useCrtUi ? crtMonoBold18 : notoSansBold18;
            var crtRichTextFont = useCrtUi ? crtMono14 : notoSans12;
            var crtButtonLabelFont = useCrtUi ? crtMonoBold14 : notoSans12;
            var crtLineEditFont = useCrtUi ? crtMono14 : notoSans12;
            ...
            var fancyWindowTitleFont = resCache.GetFont(crtMonoBoldStack, size: 13);
...
// ListContainer
                ...
                Element<Label>().Class("FancyWindowTitle")
                    .Prop("font", fancyWindowTitleFont)
